...
The old configuration state could be deleted after a successful migration to v5.
Delete the section `<component name="ProjectSettingsService">...</component>` inside the plugin file `.idea/easy-i18n.xml`.
