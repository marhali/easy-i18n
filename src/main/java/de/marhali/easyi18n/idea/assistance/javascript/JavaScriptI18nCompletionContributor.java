 ...
 * @author marhali
 */
public class JavaScriptI18nCompletionContributor extends CompletionContributor {
                ...
                protected void addCompletions(
                    ...
                    for (I18nEntryPreview suggestion : suggestions) {
                        LookupElementBuilder builder = LookupElementBuilder.create(suggestion.key().canonical())
                            .withInsertHandler(JavaScriptI18nCompletionContributor::replaceCompletionRange)
