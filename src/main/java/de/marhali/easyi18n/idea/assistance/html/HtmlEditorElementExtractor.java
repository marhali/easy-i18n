...
/**
 * Responsible for extracting {@link EditorElement} out from {@link XmlAttributeValue}.
 *
 * @author marhali
 */
public final class HtmlEditorElementExtractor implements EditorElementExtractor<XmlAttributeValue, PsiFile> {
