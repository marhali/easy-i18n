 ...
 * @author marhali
 */
public class JavaIExtractTranslationIntention extends AbstractExtractTranslationIntention {
    ...
    public boolean isAvailable(@NotNull Project project, Editor editor, @NotNull PsiElement psiElement) {
        ...
        PsiLiteralExpression literal = PsiTreeUtil.getParentOfType(psiElement, PsiLiteralExpression.class, false);
        if (literal == null) {
            return false;
        }
        ...
        dialog.registerCallback((entry) -> {
            ...
            WriteCommandAction
                ...
                .run(() -> {
                    ...
                    PsiExpression replacement = factory.createExpressionFromText(i18nFlavor, literal);
