 ...
 * @author marhali
 */
public class DartI18nCompletionContributor extends CompletionContributor {

    public DartI18nCompletionContributor() {
        extend(
            CompletionType.BASIC,
            PlatformPatterns.psiElement().withParent(DartStringLiteralExpression.class),
            new CompletionProvider<>() {
                ...
                protected void addCompletions(
                    ...
                    DartStringLiteralExpression literal = findParentOfType(position, DartStringLiteralExpression.class);
                    ...
                    String currentValue = DartEditorElementExtractor.getStringContent(literal);
                    ...
                    int quoteOffset = literal.getText().startsWith("\"\"\"") || literal.getText().startsWith("'''") ? 3 : 1;
                    TextRange absoluteValueRange = TextRange.create(
                        literalRange.getStartOffset() + quoteOffset,
                        literalRange.getEndOffset() - quoteOffset
                    );
                    ...
                    for (I18nEntryPreview suggestion : suggestions) {
                        LookupElementBuilder builder = LookupElementBuilder.create(suggestion.key().canonical())
                            .withInsertHandler(DartI18nCompletionContributor::replaceCompletionRange)
