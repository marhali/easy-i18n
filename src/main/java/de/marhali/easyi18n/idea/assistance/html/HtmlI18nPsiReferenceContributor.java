 ...
 * @author marhali
 */
public class HtmlI18nPsiReferenceContributor extends PsiReferenceContributor {

    @Override
    public void registerReferenceProviders(@NotNull PsiReferenceRegistrar psiReferenceRegistrar) {
        psiReferenceRegistrar.registerReferenceProvider(
            PlatformPatterns.psiElement(XmlAttributeValue.class),
            new HtmlI18nPsiReferenceProvider()
        );
    }

    private static final class HtmlI18nPsiReferenceProvider extends PsiReferenceProvider {
