 ...
 * @author marhali
 */
public class GoExtractTranslationIntention extends AbstractExtractTranslationIntention {
    ...
    public boolean isAvailable(@NotNull Project project, Editor editor, @NotNull PsiElement psiElement) {
        ...
        GoStringLiteral literal = findParentOfType(psiElement, GoStringLiteral.class);
        if (literal == null) {
            return false;
        }

        String text = GoEditorElementExtractor.getStringContent(literal);
    ...
    public void invoke(@NotNull Project project, Editor editor, @NotNull PsiElement psiElement) throws IncorrectOperationException {
        ...
        dialog.registerCallback((entry) -> {
            ...
            WriteCommandAction
                ...
                .run(() -> {
                    GoExpression replacement = GoElementFactory.createExpression(project, i18nFlavor);
                    if (replacement != null) {
