 ...
 * @author marhali
 */
public class RustExtractTranslationIntention extends AbstractExtractTranslationIntention {
    ...
    public boolean isAvailable(@NotNull Project project, Editor editor, @NotNull PsiElement psiElement) {
        ...
        RsLitExpr literal = findParentOfType(psiElement, RsLitExpr.class);
        if (literal == null || !RustEditorElementExtractor.isStringLiteral(literal)) {
            return false;
        }

        String text = RustEditorElementExtractor.getStringContent(literal);
