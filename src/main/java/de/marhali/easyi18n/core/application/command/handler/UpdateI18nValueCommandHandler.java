...
public class UpdateI18nValueCommandHandler implements CommandHandler<UpdateI18nValueCommand> {
    ...
    public UpdateI18nValueCommandHandler(@NotNull EnsureLoadedService ensureLoadedService, @NotNull I18nStore store, @NotNull DomainEventPublisherPort domainEventPublisherPort) {
