...
public class AddI18nRecordCommandHandler implements CommandHandler<AddI18nRecordCommand> {
    ...
    public AddI18nRecordCommandHandler(@NotNull EnsureLoadedService ensureLoadedService, @NotNull I18nStore store, @NotNull DomainEventPublisherPort domainEventPublisherPort) {
