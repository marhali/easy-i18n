...
public class UpdateI18nKeyCommandHandler implements CommandHandler<UpdateI18nKeyCommand> {
    ...
    public UpdateI18nKeyCommandHandler(@NotNull EnsureLoadedService ensureLoadedService, @NotNull I18nStore store, @NotNull DomainEventPublisherPort domainEventPublisherPort) {
